...
; CHECK-NEXT:   %insert_argument.i4 = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument.i4(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @1, i32 0, i32 0), i8* %2, i64 4)
...
; CHECK-NEXT:   %call.size.i = call i64 %get_choice.i(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i8* %4, i64 8) #2
...
; CHECK-NEXT:   %call1.size.i = call i64 %get_choice.i6(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i8* %11, i64 8) #2
...
; CHECK-NEXT:   %trace2 = call i8* %new_trace() #3
...
; CHECK-NEXT:   call void %insert_call(i8* %trace, i8* nocapture readonly getelementptr inbounds ([21 x i8], [21 x i8]* @2, i32 0, i32 0), i8* %trace2) #4
...
; CHECK-NEXT:   %insert_argument.i = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument.i(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @3, i32 0, i32 0), i8* %1, i64 8)
; CHECK-NEXT:   %2 = bitcast double %b to i64
; CHECK-NEXT:   %3 = inttoptr i64 %2 to i8*
; CHECK-NEXT:   %insert_argument.i1 = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument.i1(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @4, i32 0, i32 0), i8* %3, i64 8)
; CHECK-NEXT:   %4 = bitcast double* %data to i8*
; CHECK-NEXT:   %insert_argument.i2 = load void (i8*, i8*, i8*, i64)*, void (i8*, i8*, i8*, i64)** @insert_argument
; CHECK-NEXT:   call void %insert_argument.i2(i8* %trace, i8* nocapture readonly getelementptr inbounds ([5 x i8], [5 x i8]* @5, i32 0, i32 0), i8* %4, i64 0)
...
; CHECK-NEXT:   call void %insert_argument.i3(i8* %trace, i8* nocapture readonly getelementptr inbounds ([2 x i8], [2 x i8]* @6, i32 0, i32 0), i8* %6, i64 4)
...
; CHECK-NEXT:   %call.size.i = call i64 %get_choice.i(i8* %trace, i8* nocapture readonly getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i8* %12, i64 8) #2
; CHECK-NEXT:   %from.trace.call.i = load double, double* %call.ptr.i
